...
export const GIVE_COLOUR_INFO = 'hanabi-client/game/GIVE_COLOUR_INFO';
export const GIVE_NUMBER_INFO = 'hanabi-client/game/GIVE_NUMBER_INFO';
export const DISCARD = 'hanabi-client/game/DISCARD';
export const PLAY = 'hanabi-client/game/PLAY';

export const DEAL_CARD = 'hanabi-client/game/DEAL_CARD';
export const SET_NEXT_PLAYER = 'hanabi-client/game/SET_NEXT_PLAYER';
